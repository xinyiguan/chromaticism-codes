...
def basic_corpus_summary_stats(
    ...
    original_chord_num = len(original_c[(~original_c["chord"].isna()) & (original_c["chord"] != '') & (
            original_c["chord"] != '@none') & (original_c["chord"] != 'nan')])
...
if __name__ == "__main__":
    ...
    ex = Examples.get_example_chordlevel_df()
    chopin = ex.chopin_06_02
    print(chopin[chopin["quarterbeats"] == 24])
